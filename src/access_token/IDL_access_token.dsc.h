...
#ifndef _H_access_token_
#define _H_access_token_
...
_WINDLL_FUNC int DSCINIT_access_token( access_token *pst );

#include "fasterjson.h"

_WINDLL_FUNC int DSCSERIALIZE_JSON_access_token( access_token *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_JSON_DUP_access_token( access_token *pst , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_access_token( char *encoding , char *buf , int *p_len , access_token *pst );
