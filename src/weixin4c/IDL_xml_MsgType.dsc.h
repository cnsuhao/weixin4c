...
#ifndef _H_xml_MsgType_
#define _H_xml_MsgType_
...
_WINDLL_FUNC int DSCINIT_xml_MsgType( xml_MsgType *pst );

_WINDLL_FUNC int DSCSERIALIZE_XML_xml_MsgType( xml_MsgType *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_XML_xml_MsgType( char *encoding , char *buf , int *p_len , xml_MsgType *pst );
